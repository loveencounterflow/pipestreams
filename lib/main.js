...
;
  ...
  this.spawn = function(...P) {
    return (this.spawn_with_cp_and_source(...P))[1];
  };

  this.spawn_with_cp_and_source = function(command, settings) {
    ...
    var arity, cp, on_error, source, stderr, stderr_pipeline, stdout, stdout_pipeline;
    switch (arity = arguments.length) {
      case 1:
      case 2:
        null;
    ...
    stderr_pipeline.push(this.$collect());
    stderr_pipeline.push(this.$('null', function(lines, send) {
      var message;
      send(lines);
    ...
    stderr_pipeline.push(this.$drain());
