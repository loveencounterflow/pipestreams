(function() {
  'use strict';
  var $paramap, $pass_through, $pull_drain, $values, CND, FS, L, PATH, after, alert, assign, badge, copy, debug, declare, defer, echo, every, glob, help, info, is_empty, isa, jr, log, map, pull, pull_cont, pull_through, return_id, rpr, size_of, type_of, types, urge, validate, warn, whisper;
  ...
  this.$window = function(settings) {
    ...
    var _, buffer, defaults, fallback, had_value, last, remit_settings;
    defaults = {
      width: 3,
      fallback: null
    };
    ...
    remit_settings = {last};
    if (settings.leapfrog != null) {
      remit_settings.leapfrog = settings.leapfrog;
    }
    //.........................................................................................................
    return this.$(remit_settings, (d, send) => {
      var i, ref;
      if (d === last) {
        if (had_value) {
          for (_ = i = 1, ref = settings.width; (1 <= ref ? i < ref : i > ref); _ = 1 <= ref ? ++i : --i) {
  ...
  this.$drain = function(on_end = null) {
    ...
    return $pull_drain(null, function(error) {
      if (error != null) {
        throw error;
      }
      return on_end();
