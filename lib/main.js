...
(function() {
  'use strict';
  var CND, L, Multimix, alert, badge, debug, declare, echo, help, info, isa, log, rpr, size_of, type_of, types, urge, validate, warn, whisper;
  ...
  //###########################################################################################################
  module.exports = L = new this.Pipestreams();
