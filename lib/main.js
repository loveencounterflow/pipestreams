...
(function() {
  'use strict';
  var $pass_through, $pull_drain, $pull_split, $pull_utf8_decoder, CND, CP, FS, STPS, alert, badge, debug, echo, help, info, log, map, new_pushable, pull, pull_async_map, return_id, rpr, through, urge, warn, whisper,
    slice = [].slice;
  ...
  this._new_file_sink_using_stps = function() {
    var P;
    P = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    return STPS.sink(FS.createWriteStream.apply(FS, P));
  };
