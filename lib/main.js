...
(function() {
  'use strict';
  var $paramap, $pass_through, $pull_drain, $values, CND, FS, L, PATH, after, alert, assign, badge, copy, debug, defer, echo, every, glob, help, info, is_empty, jr, log, map, pull, pull_cont, pull_through, return_id, rpr, urge, warn, whisper;
  ...
  this.$mark_position = function() {
    ...
    var first, last, prv, ref, ref1;
    first = (ref = typeof settings !== "undefined" && settings !== null ? settings.first : void 0) != null ? ref : this._symbols.first;
    last = (ref1 = typeof settings !== "undefined" && settings !== null ? settings.last : void 0) != null ? ref1 : this._symbols.last;
    first = true;
    prv = [];
