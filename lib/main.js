...
(function() {
  ...
  this.new_refillable_source = function(values, settings) {
    ...
    settings = assign({
      repeat: 1,
      trailer: this._symbols.discard,
      show: false
    }, settings);
    trailer_count = 0;
    //.........................................................................................................
    filter = this.$filter((d) => {
      return d !== this._symbols.discard;
    });
    //.........................................................................................................
    read = (abort, handler) => {
      var value;
  ...
  this.$watch = function(settings, method) {
    ...
    switch (arity = arguments.length) {
      ...
      case 2:
        ...
        for (key in settings) {
          value = settings[key];
          settings[key] = [this._symbols.surround, value];
        }
        //.....................................................................................................
        return this.$(settings, (d, send) => {
          if ((CND.isa_list(d)) && (d[0] === this._symbols.surround)) {
            method(d[1]);
          } else {
            method(d);
            send(d);
