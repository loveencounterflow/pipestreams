...
(function() {
  'use strict';
  var $paramap, $pass_through, $pull_drain, $values, CND, CP, FS, L, PATH, after, alert, assign, badge, copy, debug, defer, echo, every, glob, help, info, is_empty, jr, log, map, pull, pull_cont, pull_through, return_id, rpr, symbols, urge, warn, whisper;
