...
(function() {
  'use strict';
  var $pass_through, $pull_drain, $pull_split, $pull_utf8_decoder, $stringify, $take, $values, CND, CP, FS, L, PATH, after, alert, badge, debug, defer, echo, glob, help, info, log, new_pushable, pluck, pull, pull_cont, pull_many, pull_through, return_id, rpr, unpack_sym, urge, warn, whisper;
