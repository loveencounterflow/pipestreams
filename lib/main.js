...
(function() {
  ...
  this.$ = this.remit = function(hint, method) {
    var arity, client_arity, defaults, last_data, on_data, on_end, self, send, settings, type;
    ...
    //.........................................................................................................
    if ((last_data = settings.last) !== this.symbols.misfit) {
      on_end = function() {
        self = this;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.$async = function(hint, method) {
    var arity, end_sym, pipeline, ref, type;
    ...
    switch (arity = arguments.length) {
      ...
      case 2:
        if (hint !== 'null') {
          throw new Error(`µ18594 unknown hint ${rpr(hint)}`);
        }
        break;
      default:
        throw new Error(`µ19359 expected 1 or 2 arguments, got ${arity}`);
    }
    if ((type = CND.type_of(method)) !== 'function') {
      //.........................................................................................................
    ...
    //.........................................................................................................
    if (hint === 'null') {
      pipeline.push(this.$('null', (d, send) => {
        return send(d != null ? d : end_sym);
      }));
    }
    //.........................................................................................................
