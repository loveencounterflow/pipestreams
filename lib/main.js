...
(function() {
  'use strict';
  var $pass_through, $pull_drain, $pull_split, $pull_utf8_decoder, $stringify, $take, $values, CND, CP, Event_emitter, FS, L, STPS, after, alert, badge, debug, defer, echo, help, info, log, new_pushable, pluck, pull, pull_cont, pull_many, pull_through, return_id, rpr, unpack_sym, urge, warn, whisper;
...
;
  ...
  (function() {
    ...
    for (key in L) {
      ...
      results.push(L[key] = value.bind(L));
    }
    return results;
  })();
