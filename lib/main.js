...
(function() {
  'use strict';
  var $pass_through, $pull_drain, $pull_split, $pull_utf8_decoder, $stringify, $take, $values, CND, CP, Event_emitter, FS, STPS, alert, badge, debug, echo, help, info, log, map, new_pushable, pluck, pull, pull_async_map, pull_cont, pull_many, pull_through, return_id, rpr, urge, warn, whisper,
    slice = [].slice;
...
;
  ...
  this.spawn_collect = function(...P) {
    var $on_data, handler, i, pipeline, ref, source;
    ...
    $on_data = () => {
      ...
      return this.$watch((event) => {
        ...
        switch (key) {
          ...
          default:
            throw new Error("internal error 2201991");
        }
        return null;
      });
    };
  ...
  this._spawn = function(command, settings) {
    var $ensure_event_order, arity, command_source, confluence, cp, error_to_exit, event_buffer, event_pipeline, funnel, shell, source, stderr, stderr_pipeline, stdout, stdout_is_binary, stdout_pipeline, type;
    switch (arity = arguments.length) {
      case 1:
      case 2:
        null;
    ...
    switch (type = CND.type_of(command)) {
      ...
      case 'list':
        ...
        break;
      default:
        throw new Error(`expected a text or list for command, got a ${type}`);
    }
    ...
    cp.on('exit', (code, signal) => {
      ...
      return event_buffer.push(['exit', {code, signal}]);
    });
          ...
          if (event != null) {
            ...
            switch (key) {
              ...
              case 'exit':
                ...
                return send(event);
              default:
                throw new Error("internal error 110918");
            }
          }
        });
      })());
