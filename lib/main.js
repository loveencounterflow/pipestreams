...
;
  ...
  this._spawn = function(command, settings) {
    var $ensure_event_order, arity, command_source, command_type, comments, confluence, cp, error_to_exit, event_buffer, event_pipeline, funnel, source, stderr, stderr_pipeline, stdout, stdout_is_binary, stdout_pipeline;
    switch (arity = arguments.length) {
      case 1:
      case 2:
        null;
    ...
    switch (command_type = CND.type_of(command)) {
      ...
      case 'list':
        ...
        break;
      default:
        throw new Error(`expected a text or a list for command, got ${command_type}`);
    }
