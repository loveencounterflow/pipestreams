...
(function() {
  'use strict';
  var $paramap, $pass_through, $pull_drain, $values, CND, CP, FS, L, PATH, after, alert, assign, badge, copy, debug, defer, echo, every, glob, help, info, is_empty, jr, log, map, pull, pull_cont, pull_through, return_id, rpr, urge, warn, whisper;
  ...
  // pull_through              = require '/tmp/deps/node_modules/pull-through/index.js'; warn 'using /tmp/deps/node_modules/pull-through/index.js'
  ...
  this.new_refillable_source = function(values, settings) {
    var R, filter, read, trailer_count;
    settings = assign({
      repeat: 1,
      trailer: this.symbols.discard,
      show: false
    }, settings);
    trailer_count = 0;
    //.........................................................................................................
    filter = this.$filter((d) => {
      return d !== this.symbols.discard;
    });
    //.........................................................................................................
    read = (abort, handler) => {
      var value;
  ...
  this.$ = this.remit = function(...P) {
    ...
    on_end = function() {
      ...
      this.queue(PS.symbols.end);
      return null;
    };
    //.........................................................................................................
    // return pull_through on_data, on_end
    return pull_through(on_data);
  };
  ...
  this.$watch = function(settings, method) {
    ...
    switch (arity = arguments.length) {
      ...
      case 2:
        ...
        for (key in settings) {
          value = settings[key];
          settings[key] = [this.symbols.surround, value];
        }
        //.....................................................................................................
        return this.$(settings, (d, send) => {
          if ((CND.isa_list(d)) && (d[0] === this.symbols.surround)) {
            method(d[1]);
          } else {
            method(d);
            send(d);
