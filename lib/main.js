...
(function() {
  'use strict';
  var $paramap, $pass_through, $pull_drain, $values, CND, CP, FS, L, PATH, _map_errors, _new_push_source, after, alert, assign, badge, copy, debug, defer, echo, glob, help, info, is_empty, jr, log, pull, pull_cont, pull_through, return_id, rpr, unpack_sym, urge, warn, whisper;
