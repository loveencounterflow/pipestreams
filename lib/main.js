...
(function() {
  'use strict';
  var $pass_through, $pull_drain, $pull_split, $pull_utf8_decoder, $stringify, $take, $values, CND, CP, FS, STPS, alert, badge, debug, echo, help, info, log, map, new_pushable, pull, pull_async_map, pull_through, return_id, rpr, urge, warn, whisper,
    slice = [].slice;
