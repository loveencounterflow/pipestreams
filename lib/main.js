...
;
  ...
  this._spawn = function(command, settings) {
    var $ensure_event_order, arity, command_source, confluence, cp, event_buffer, event_pipeline, funnel, shell, source, stderr, stderr_pipeline, stdout, stdout_is_binary, stdout_pipeline, type;
    switch (arity = arguments.length) {
      case 1:
      case 2:
        null;
