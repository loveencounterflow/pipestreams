  ...
  this.new_refillable_source = function(values, settings) {
    ...
    read = (abort, handler) => {
      ...
      if (values.length === 0) {
        trailer_count += +1;
        if (settings.show) {
          info('23983', `refillable source depeleted: ${trailer_count} / ${settings.repeat}`);
        }
