...
(function() {
  'use strict';
  var $pass_through, $pull_drain, $pull_split, $pull_utf8_decoder, $take, CND, CP, FS, PRFLR, STPS, alert, badge, debug, echo, help, info, log, map, new_pushable, pull, pull_async_map, return_id, rpr, through, urge, warn, whisper,
    slice = [].slice;
