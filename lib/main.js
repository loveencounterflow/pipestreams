...
(function() {
  'use strict';
  var $pass_through, $pull_drain, $pull_split, $pull_utf8_decoder, $stringify, $take, $values, CND, CP, Event_emitter, FS, STPS, alert, badge, debug, echo, help, info, log, new_pushable, original_map, pluck, pull, pull_async_map, pull_cont, pull_many, pull_through, return_id, rpr, urge, warn, whisper,
    splice = [].splice;
  ...
  */
  ...
  this._map_errors = function(...P) {
    return original_map(...P);
  };
