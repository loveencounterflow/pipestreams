...
(function() {
  'use strict';
  var $collect_A, $foo, $is_equal, $square, CND, O, PS, after, alert, badge, debug, defer, echo, every, help, infinite_counter, info, is_empty, jr, log, map, map_with_end, pull, rpr, sink, source_from_values, take, test, urge, warn, whisper;
...
//.........................................................................................................
  ...
  this["demo through with null"] = async function(T, done) {
    var error, j, len, matcher, probe, probes_and_matchers, remit, through;
    // through = require 'pull-through'
    through = require('../../../pull-through-with-end-symbol');
    probes_and_matchers = [[[true, [5, 15, 20, void 0, 25, 30]], [10, 30, 40, void 0, 50, 60]], [[false, [5, 15, 20, void 0, 25, 30]], [10, 30, 40, void 0, 50, 60]], [[true, [5, 15, 20, null, 25, 30]], [10, 30, 40, null, 50, 60]], [[false, [5, 15, 20, null, 25, 30]], [10, 30, 40, null, 50, 60]]];
    //.........................................................................................................
    remit = function(use_on_end, method) {
      var count, end_sym, on_data, on_end, self, send;
...
//.........................................................................................................
    for (j = 0, len = probes_and_matchers.length; j < len; j++) {
      ...
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve) {
          var collector, on_data, on_end, pipeline, source, use_on_end, values;
          [use_on_end, values] = probe;
          //.....................................................................................................
          on_data = function(d) {
            return this.queue(d != null ? d * 2 : d);
          };
          //.....................................................................................................
          on_end = function() {
          ...
          pipeline.push(remit(use_on_end, function(d, send) {
  ...
  if (module.parent == null) {
    null;
    // test @
    test(this["demo through with null"]);
  }
