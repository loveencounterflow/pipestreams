...
(function() {
  //###########################################################################################################
  var $, $async, CND, PS, after, alert, async_with_end_detection, async_with_end_detection_2, async_with_first_and_last, badge, debug, defer, demo_alternating_source, demo_merge_1, demo_merge_async_sources, demo_mux_async_sources_1, demo_mux_async_sources_2, demo_on_demand_source, demo_on_demand_transform, demo_through, duplex_stream_3, echo, every, generator_source, help, info, is_empty, jr, log, new_async_source, pull_pair_1, pull_pair_2, rpr, sync_with_first_and_last, urge, warn, whisper, wye_1, wye_2, wye_3b, wye_4, wye_with_external_push_source, wye_with_internal_push_source, wye_with_random_value_source, wye_with_value_source;
...
// mainsource.send n for n in [ 1 .. 5 ]
  ...
  if (module.parent == null) {
    (async function() {
      ...
      return (await demo_on_demand_source());
    })();
  }
