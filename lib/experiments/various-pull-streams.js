...
(function() {
  //###########################################################################################################
  var $, $async, CND, PS, after, alert, async_with_end_detection, async_with_end_detection_2, badge, debug, demo_merge_1, demo_merge_async_sources, demo_mux_async_sources_1, demo_mux_async_sources_2, demo_through, echo, help, info, is_empty, jr, log, new_async_source, rpr, urge, warn, whisper;
  ...
  /* https://github.com/pull-stream/pull-through */  async_with_end_detection = function() {
    var buffer, end_sym, flush, pipeline, send, start_sym;
