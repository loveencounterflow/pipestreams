...
(function() {
  //###########################################################################################################
  var $, $async, CND, PS, after, alert, async_with_end_detection, async_with_end_detection_2, async_with_first_and_last, badge, debug, defer, demo_merge_1, demo_merge_async_sources, demo_mux_async_sources_1, demo_mux_async_sources_2, demo_through, duplex_stream_3, echo, every, help, info, is_empty, jr, log, new_async_source, pull_pair_1, pull_pair_2, rpr, sync_with_first_and_last, urge, warn, whisper, wye_1, wye_2, wye_3;
  ...
  wye_3 = async function() {
    ...
    demo = function() {
      return new Promise(function(resolve) {
        var byline, mainline;
        byline = [];
        byline.push(PS.new_random_async_value_source(0.5, [3, 4, 5, 6, 7, 8]));
        byline.push(PS.$watch(function(d) {
          return whisper('bystream', jr(d));
        }));
        //.......................................................................................................
