...
(function() {
  'use strict';
  var $, $async, CND, PS, STACKTRACE, after, alert, assign, badge, debug, defer, echo, every, get_logger, get_source/* https://github.com/felixge/node-stack-trace */, get_source_ref, help, info, inspect, is_empty, jr, log, rpr, test, urge, warn, whisper, xrpr,
  ...
  //-----------------------------------------------------------------------------------------------------------
  /* https://github.com/xpl/get-source */  get_source_ref = function(delta, prefix, color) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  get_logger = function(letter, color) {
    var transform_nr;
    transform_nr = 0;
...
//.........................................................................................................
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve) {
          var bylog, collector, mainline, mainlog, use_defer;
          //.....................................................................................................
          get_source = function*() {
            while (true) {
