...
(function() {
  var $, $async, CND, FS, OS, PATH, PS, TAP, alert, badge, debug, echo, help, info, jr, log, rpr, step, urge, warn, whisper;
  ...
  TAP.test("spawn 2", function(T) {
    ...
    probes_and_matchers = [
      [
        "xxx ; echo \"helo\" && exit 1", "CDDX", {
          "code": 1,
          "signal": null,
          "comment": "error"
        }, "helo", "/bin/sh: xxx: command not found"
      ], [
        "xxx ; echo \"helo\" && exit 0", "CDDX", {
          "code": 0,
          "signal": null,
          "comment": "ok"
        }, "helo", "/bin/sh: xxx: command not found"
        ...
        "ls package.json && echo_to_stderr() { cat <<< \"$@\" 1>&2; }; echo_to_stderr what", "CDDX", {
          "code": 0,
          "signal": null,
          "comment": "ok"
        }, "package.json", "what"
        ...
        "echo_to_stderr() { cat <<< \"$@\" 1>&2; }; echo_to_stderr what; echo else; sleep 1; kill -9 $$", "CDDX", {
          "code": 137,
          "signal": "SIGKILL",
          "comment": "SIGKILL"
        }, "else", "what"
        ...
        "bonkers 2>&1; exit 0", "CDX", {
          "code": 0,
          "signal": null,
          "comment": "ok"
        }, "/bin/sh: bonkers: command not found", ""
      ], [
        "bonkers; echo \"success!\"; exit 0", "CDDX", {
          "code": 0,
          "signal": null,
          "comment": "ok"
        }, "success!", "/bin/sh: bonkers: command not found"
      ], [
        "bonkers; echo \"success!\"; kill -27 $$", "CDDX", {
          "code": 155,
          "signal": "SIGPROF",
          "comment": "SIGPROF"
        }, "success!", "/bin/sh: bonkers: command not found"
    ...
    probes_and_matchers = [
      [
        "bonkers; echo \"success!\"; kill -27 $$", {
          ...
          "signal": "SIGPROF",
          "comment": "SIGPROF"
        }, [["stderr", "/bin/sh: bonkers: command not found"], ["stdout", "success!"]]
      ], [
        "echo \"success!\"; kill -27 $$", {
          "command": "echo \"success!\"; kill -27 $$",
          "stdout": [],
