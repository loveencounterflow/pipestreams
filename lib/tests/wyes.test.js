...
(function() {
  'use strict';
  var $, $async, CND, FS, OS, PATH, PS, alert, badge, debug, defer, echo, help, info, inspect, is_empty, jr, log, new_filtered_bysink, provide_wye, rpr, test, urge, warn, whisper, xrpr;
  ...
  //-----------------------------------------------------------------------------------------------------------
  provide_wye = function() {
    return this.$wye = function(stream, use_defer) {
