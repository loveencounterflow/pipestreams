...
(function() {
  'use strict';
  var $, $async, CND, FS, OS, PATH, PS, alert, badge, debug, defer, echo, help, info, inspect, is_empty, jr, log, new_filtered_bysink, rpr, test, urge, warn, whisper, xrpr,
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve, reject) {
          ...
          mainline = [];
          //.....................................................................................................
          byline.push((use_bystream_vs ? PS.new_value_source : PS.new_random_async_value_source)(byline_values));
          byline.push(PS.$show({
            title: 'bystream'
          }));
          bystream = PS.pull(...byline);
          //.....................................................................................................
          mainline.push((use_mainstream_vs ? PS.new_value_source : PS.new_random_async_value_source)(mainline_values));
          mainline.push(PS.$show({
            title: 'mainstream'
          }));
      ...
      await T.perform(probe, matcher, error, function() {
        return new Promise(function(resolve, reject) {
          ...
          if (use_mainstream_vs) {
            mainline.push(PS.new_value_source(mainline_values));
          } else {
            mainline.push(PS.new_random_async_value_source(mainline_values));
          }
          mainline.push(PS.$show({
            title: 'mainstream'
          }));
