...
(function() {
  ...
  provide_$wye = function() {
    ...
    return this.$wye = function(bysource) {
      var R, bystream, bystream_ended, bystream_started, mainstream, mainstream_ended, send;
      send = null;
      ...
      //.........................................................................................................
      mainstream = [];
      mainstream.push(this.$('null', (d, send) => {
        if (d == null) {
          mainstream_ended = true;
        }
        return send(d);
      }));
      mainstream.push(this.$async((d, _send, done) => {
        send = _send;
        if (!bystream_started) {
      ...
      mainstream.push(this.$defer());
      // mainstream.push @$tee ( d ) => urge '***', d
      //.........................................................................................................
      bystream = [];
      bystream.push(this.$show());
