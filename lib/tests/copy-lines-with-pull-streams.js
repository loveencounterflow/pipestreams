...
(function() {
  ...
  TAP.test("performance regression", function(T) {
    var $as_line, $as_text, $count, $filter_comments, $filter_empty, $filter_incomplete, $on_start, $on_stop, $pass, $select_fields, $split_fields, $trim, XXX_through2, i, idx, input, input_path, item_count, output, output_path, pipeline, push, ref, t0, t1;
  ...
  ;
    ...
    push(XXX_through2(function(data, send) {
      urge(data);
      send(data);
      return send(data);
    }));
