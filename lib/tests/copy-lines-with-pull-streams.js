...
(function() {
  ...
  * implementation model for pass-throughs
   ...
   */
  var $, $async, $drain, $split, $stringify, $utf8, CND, FS, PATH, PRFLR, PS, S, STPS, TAP, V8PROFILER, _, async_map, badge, debug, echo, error, format_float, format_integer, help, i, info, new_file_source, new_numeral, pull, rpr, start_profile, stop_profile, through, urge, warn, whisper;
  ...
  ;
    ...
    push(PS.map(function(data) {
      PRFLR.start('$as_text2');
      return data;
    }));
    push($as_text());
    push(PS.map(function(data) {
