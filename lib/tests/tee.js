...
(function() {
  ...
  TAP.test("tee (using pull-tee)", function(T) {
    ...
    sink_0.on('finish', (function(_this) {
      return function() {
        sink_0_finished = true;
        return finish();
      };
    })(this));
    sink_1.on('finish', (function(_this) {
      return function() {
        sink_1_finished = true;
        return finish();
      };
    })(this));
    sink_2.on('finish', (function(_this) {
      return function() {
    ...
    stream_1 = pull.apply(null, ppline_1);
    ppline_2 = [];
    ppline_2.push($keep_even());
    ppline_2.push($link('+'));
    ppline_2.push(sink_2);
    stream_2 = pull.apply(null, ppline_2);
    ppline_0 = [];
    ...
    stream_0 = pull.apply(null, ppline_0);
    return null;
  });

  TAP.test("tee (using pipestreams)", function(T) {
