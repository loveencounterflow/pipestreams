...
(function() {
  //###########################################################################################################
  var $, $async, $pull_drain, $take, $values, CND, FS, OS, PATH, PS, alert, badge, debug, defer, echo, help, info, log, pull, pull_through, read, rpr, test, urge, warn, whisper,
    indexOf = [].indexOf;
