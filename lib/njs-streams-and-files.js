(function() {
  ...
  this.write_to_file = function(path, options, on_stop) {
    ...
    //.........................................................................................................
    return this.mark_as_sink(this.write_to_nodejs_stream(FS.createWriteStream(path, options), on_stop));
  };
  ...
  this.write_to_nodejs_stream = function(stream, on_stop) {
    ...
    return this.mark_as_sink(TO_PULL_STREAM.sink(stream, function(error) {
      return finish(error);
    }));
  };
  ...
  this.node_stream_from_sink = function(sink) {
    return this.mark_as_sink(TO_NODE_STREAM.sink(sink));
  };
